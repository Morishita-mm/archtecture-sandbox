...
export const ScenarioSetup: React.FC<Props> = ({ initialScenario, onConfirm, onCancel }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onConfirm({
      ...
      description,
      difficulty,
      // requirementsはAIが決めるため空文字またはダミーを入れておく
      requirements: {
        users: 'ヒアリングで特定',
        traffic: 'ヒアリングで特定',
  ...
  return (
    <div style={containerStyle}>
      <div style={cardStyle}>
        ...
        <p style={descStyle}>
          あなたが設計したいシステム（ゲーム、EC、SNSなど）を定義してください。<br />
          <strong>具体的な数値（トラフィックなど）は、クライアント役のAIとの会話で探る必要があります。</strong>
        </p>
            ...
            <div style={radioGroupStyle}>
              <label style={radioLabelStyle(difficulty === 'small')}>
                ...
                <div>
                  ...
                  <div style={{fontSize:'12px', color:'#666'}}>社内ツール・個人開発レベル</div>
                </div>
              </label>
              ...
              <label style={radioLabelStyle(difficulty === 'medium')}>
                ...
                />
                 <div>
                  ...
                  <div style={{fontSize:'12px', color:'#666'}}>急成長中のスタートアップ</div>
                </div>
              </label>
              ...
              <label style={radioLabelStyle(difficulty === 'large')}>
                ...
                />
                 <div>
                  ...
                  <div style={{fontSize:'12px', color:'#666'}}>Global・ミッションクリティカル</div>
                </div>
              </label>
            </div>
          </div>
